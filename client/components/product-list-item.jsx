...
export default function ProductListItem(props) {
  return (
    <div id={props.productId} className="d-flex flex-row h-45 col-lg-3 col-md-9 mb-4 mx-4 shadow bg-white">
      <div className="list-item d-flex select vw-100 vh-100 align-items-center">
        <div className="d-flex flex-column justify-content-center card-body">
          <img src={props.product.image} className="card-img-top h-50 mt-2" alt={props.product.name} />
